      ...
      <div className='project'>
        <div className='project-main'>
          ...
          <div className='text'>
            ...
            <p>Gmini est un dérivé de jumeaux. L'objectif recherché est que les modèles puissent se voir <b>tels qu'ils sont réellement</b>, au travers d'un oeil extérieur.</p>
            <p>Un shooting réussi, pour moi, comprend <b>4 réations</b> : </p>
            <ul>
              ...
              <li><p>⭐ S'exalter !</p><p className='end'>Repartir confiant en sa personne</p></li>
            </ul>
          </div>
        </div>
